      ...
      <table style={{ width: "100%", fontSize: "8pt", borderCollapse: "collapse", marginBottom: "3mm" }}>
        <thead>
          <tr style={{ backgroundColor: "#1e3a5f", color: "white" }}>
            <th style={{ padding: "1.5mm 1mm", textAlign: "center", width: "8%" }}>ت</th>
            <th style={{ padding: "1.5mm 1mm", textAlign: "right" }}>المنتج</th>
            <th style={{ padding: "1.5mm 1mm", textAlign: "center", width: "10%" }}>قطع</th>
            <th style={{ padding: "1.5mm 1mm", textAlign: "center", width: "10%" }}>كرتون</th>
            <th style={{ padding: "1.5mm 1mm", textAlign: "center", width: "14%" }}>السعر</th>
            <th style={{ padding: "1.5mm 1mm", textAlign: "center", width: "16%" }}>المجموع</th>
          </tr>
        </thead>
        <tbody>
          {order.items?.map((item, i) => (
            <tr key={item.id} style={{ borderBottom: "1px solid #eee" }}>
              ...
              <td style={{ padding: "1.5mm 1mm", textAlign: "center" }}>{item.unitPrice?.toFixed(2)}</td>
              <td style={{ padding: "1.5mm 1mm", textAlign: "center", fontWeight: 700 }}>{item.total?.toFixed(2)}</td>
            </tr>
          ))}
        </tbody>
      </table>
